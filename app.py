from collections import defaultdict # <-- Dòng này đã được thêm vào đây
import os
...
from itertools import groupby # Giữ nguyên dòng này, mặc dù không sử dụng trực tiếp itertools.groupby nữa
...
def history():
    ...
    return render_template('history.html', grouped_records=grouped_records) # <-- THAY ĐỔI Ở ĐÂY
